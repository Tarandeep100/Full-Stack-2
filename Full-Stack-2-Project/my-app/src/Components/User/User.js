...
class User extends React.Component {
  ...
  handleRowSelection = (e) => {
    ...
    // console.log("e=>", e);
    // console.log(this.state.UserData.filter((r) => r._id == e));
    this.setState({
      // deletedRows: [this.state.UserData.filter((r) => e.includes(r._id))],
      deletedRows: e,
    });
  };
  ...
  handlePurge = () => {
    ...
    axios.post(backendUrl+'/deleteUserData', {
